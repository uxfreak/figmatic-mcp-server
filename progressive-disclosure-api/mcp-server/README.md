...
Exposes 39 powerful tools that enable AI agents (Claude Desktop, ChatGPT, etc.) to read and manipulate Figma designs through a standardized MCP interface.

---

## Features

✅ **39 MCP Tools** (8 READ + 30 WRITE + 1 UTILITY)
